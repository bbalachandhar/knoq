                        ...
                        <div class="card p-4 w-100">
                            ...
                            <div class="badge-section mb-2">
                                <span class="badge badge-soft-success text-end d-inline-block float-end">
                                    {{ $value->projectRemainingDaysToComplete() > 0 ? $value->projectRemainingDaysToComplete() : 0 }} {{ __('index.days') }}
                                </span>
                            </div>
                            ...
                            <div class="status-section">
                                <ul class="d-flex list-unstyled mb-3">
                                    ...
                                    <li class="ms-2">
                                    <span class="btn btn-{{ $value->is_active ? 'success' : 'danger' }} btn-xs {{ $value->projectRemainingDaysToComplete() <= 0 ? '' : 'toggleStatus'}}"
