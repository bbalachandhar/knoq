...
Route::group([
    ...
    Route::group(['middleware' => ['admin.auth','permission']], function () {
        ...
        Route::delete('employees/passport-attachment/{id}', [UserController::class, 'deletePassportAttachment'])->name('employees.delete-passport-attachment');
        Route::delete('employees/visa-attachment/{id}', [UserController::class, 'deleteVisaAttachment'])->name('employees.delete-visa-attachment');
