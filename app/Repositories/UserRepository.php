...
class UserRepository
{
    ...
    public function store($validatedData)
    {
        ...
        if (isset($validatedData['passport_copies'])) {
            $this->storePassportAttachments($user, $validatedData['passport_copies']);
        }
        return $user;
    }
    ...
    public function update($userDetail, $validatedData)
    {
        ...
        if (isset($validatedData['passport_copies'])) {
            $this->storePassportAttachments($userDetail, $validatedData['passport_copies']);
        }
        return $userDetail;
    }

    public function storePassportAttachments(User $user, array $attachments): void
    {
        foreach ($attachments as $attachment) {
            $fileName = $this->storeImage($attachment, \App\Models\PassportAttachment::UPLOAD_PATH);
            $user->passportAttachments()->create([
                'file_path' => \App\Models\PassportAttachment::UPLOAD_PATH,
                'file_name' => $fileName,
